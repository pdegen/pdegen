...
<template>
  ...
  <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" href="#page-top">Peter Degen</a>
      <button
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ms-auto">
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded" href="#cv">CV</a>
          </li>
          <li class="nav-item mx-0 mx-lg-1">
  ...
  <header class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
      ...
      <!-- Masthead Heading-->
      <h1 class="masthead-heading text-uppercase mb-0">Peter Degen</h1>
      <!-- Icon Divider-->
      ...
      <div class="timeline">
        <div class="timeline-item">
          ...
          <div class="timeline-content">
            ...
            <p class="text-muted mb-0">Center for Reproducible Science, University of Zurich</p>
            <small class="text-muted">June 2025 – Present</small>
          </div>
        </div>
        <div class="timeline-item">
          <div class="timeline-icon bg-primary text-white">
          ...
          <div class="timeline-content">
            ...
            <small class="text-muted">Dec 2024 – Apr 2025</small>
          </div>
        </div>
        <div class="timeline-item">
          <div class="timeline-icon bg-primary text-white"><i class="fas fa-university"></i></div>
          <div class="timeline-content">
            <h5>PhD in Computational Biology</h5>
            <p class="text-muted mb-0">Department for BioMedical Research, University of Bern</p>
            <small class="text-muted">May 2021 – November 2024</small>
          </div>
        </div>
        <div class="timeline-item">
          <div class="timeline-icon bg-primary text-white"><i class="fas fa-university"></i></div>
          <div class="timeline-content">
            <h5>BSc & MSc in Physics</h5>
            <p class="text-muted mb-0">Department of Physics, ETH Zurich</p>
            <small class="text-muted">September 2014 – September 2020</small>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-md-6 col-lg-4 mb-5">
          ...
          >
            ...
            <img
              class="img-fluid"
              src="@/assets/img/portfolio/bootstrapseq.png"
              alt="BootstrapSeq"
            />
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4 mb-5">
          ...
          >
            ...
            <img
              class="img-fluid"
              src="@/assets/img/portfolio/quotebrowser.png"
              alt="QuoteBrowser"
            />
          </div>
        </div>
    ...
    <div class="container justify-content-center">
      ...
      <div>
        ...
        <a
          ...
          >doi: 10.1371/journal.pcbi.1011630</a
        >
      </div>
      <br />
  ...
  <section class="page-section bg-light" id="skills">
    <div class="container">
      ...
      <div class="divider-custom">
        <div class="divider-custom-line"></div>
        <div class="divider-custom-icon"><i class="fas fa-gear"></i></div>
        <div class="divider-custom-line"></div>
      </div>

      <div class="row">
        <div class="col-md-6 mb-4">
          <h5>Data Analysis (Python, R)</h5>
          <div class="progress">
            <div
        ...
        <div class="col-md-6 mb-4">
          <h5>Frontend Development (HTML, CSS, TypeScript, Vue.js)</h5>
          <div class="progress">
            <div
              class="progress-bar bg-primary"
              role="progressbar"
          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-8">
                ...
                <p class="mb-4">
                  Bootstrap resample your low-powered RNA-Seq data set to estimate the expected
                  reliability of downstream differential expression and enrichment results.
                  Available via
                  <a
                    href="https://github.com/pdegen/BootstrapSeq"
                    target="_blank"
                    rel="noopener noreferrer"
                    >GitHub.</a
                  >
          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-8">
                ...
                <!-- Portfolio Modal - Text-->
                <p class="mb-4">
                  One reason why I like to read e-books is that I can easily highlight noteworthy
                  passages and quickly retrieve them across my entire digital library. At time of
                  writing, I have close to 5'000 highlights (aka clippings) saved on my Kindle,
                  which I frequently consult whenever I'm writing or thinking about a related topic.
                  However, these clippings are stored in a plain text file, which is unwieldy to
                  navigate. Therefore, I made a simple web page that lets users upload their
                  clippings for improved browsing, sorting, filtering, and sharing. Available via
                  <a
                    href="https://github.com/pdegen/QuoteBrowser"
                    target="_blank"
                    rel="noopener noreferrer"
                    >GitHub.</a
                  >
